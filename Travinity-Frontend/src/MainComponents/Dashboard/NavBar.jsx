...
const NavBar = () => {
  ...
  return (
    <section
      className={`mx-auto text-white fixed z-50 px-8 py-5 transition-transform duration-300 bg-gradient-to-b from-black/85 via-black/50 to-transparent backdrop-blur-sm ${
        ...
        <div className="flex flex-col w-3/4 flex-[0.80]">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex justify-end items-center space-x-6 pr-0">
              {/* Customer Support */}
              <a href="#" className="text-lg text-white hover:text-yellow-500">
              ...
              {/* User Dropdown */}
              <button
                className="relative flex items-center text-lg hover:text-yellow-500"
          ...
          <div className={`mt-4 flex justify-start space-x-9 text-lg ${visibleItems === 0 ? "hidden" : ""}`}>
            {/* Visible Items */}
            {navItems
              ...
              .map((item) => (
                <a
                  key={item}
                  href="#"
                  className="text-white text-[18px] hover:text-yellow-500 relative group transition duration-300 whitespace-nowrap"
                >
                  {item}
