...
import p1 from "../../assets/recommended/offers01.png";
import p2 from "../../assets/recommended/offers02.png";
import p3 from "../../assets/recommended/offers03.png";
import p4 from "../../assets/recommended/offers04.webp";
import p5 from "../../assets/recommended/offers05.webp";
import p6 from "../../assets/recommended/offers06.jpg";
import p7 from "../../assets/recommended/offers07.jpg";
import p8 from "../../assets/recommended/offers08.webp";
import p9 from "../../assets/recommended/offers09.jpg";
import p10 from "../../assets/recommended/offers10.jpg";
import p11 from "../../assets/recommended/offers11.jpg";
import p12 from "../../assets/recommended/offers12.webp";
...
function RecommendedSection() {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap">
          <div className="w-full lg:w-1/2 mb-4 lg:mb-0">
            <h4 className="text-2xl font-bold text-blue-600 mb-0">Recommended</h4>
            <p className="mb-0 text-green-500">International & Domestic fames ac ante ipsum</p>
          </div>
  ...
  whileTap="tap"
  className={`${
    activeSection === "Hotels" ? "bg-blue-600" : "bg-blue-500"
...
<AnimatedButton
  ...
  whileTap="tap"
  className={`${
    activeSection === "Flight" ? "bg-blue-600" : "bg-blue-500"
...
<AnimatedButton
  ...
  whileTap="tap"
  className={`${
    activeSection === "Rental" ? "bg-blue-600" : "bg-blue-500"
  } text-white font-semibold py-2 px-4 mx-2 rounded-lg shadow-lg transition-all duration-300 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300`}
        ...
        <div className="flex flex-wrap mt-8">
          {visibleCards.map((item) => (
            <motion.div
              ...
              whileHover="hover"
            >
              <div className="card-wrap p-4 bg-white rounded-lg shadow-lg transition duration-500 ease-in-out transform">
